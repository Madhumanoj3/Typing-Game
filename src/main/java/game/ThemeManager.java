...
public class ThemeManager {
    ...
    public static final List<ThemeDef> ALL_THEMES = List.of(
        ...
        new ThemeDef("deep_ocean",   "Deep Ocean",    "#001520","#002235","#001a2b","#003050","#06b6d4","#0891b2","#22d3ee", "LEVEL",  6, 0),
        new ThemeDef("arctic_ice",   "Arctic Ice",    "#0d1b2a","#0f2030","#0b1520","#1a3040","#67e8f9","#22d3ee","#a5f3fc", "LEVEL",  7, 0),
        new ThemeDef("aurora",       "Aurora Borealis","#030d1a","#071e30","#041525","#0d2840","#2dd4bf","#0d9488","#5eead4","LEVEL",  8, 0),
        new ThemeDef("sunset_orange","Sunset Orange", "#1a0e05","#2a1a08","#200e05","#3a2010","#f97316","#ea580c","#fb923c", "LEVEL", 10, 0),
        new ThemeDef("cyberpunk",    "Cyberpunk",     "#0a0510","#100a1f","#08031a","#1a0e30","#f0abfc","#d946ef","#f5d0fe", "LEVEL", 11, 0),
        ...
        new ThemeDef("ruby",         "Ruby Dark",     "#1a0000","#2a0505","#1e0000","#380a0a","#dc2626","#b91c1c","#f87171", "COINS",  0, 70),
        ...
        new ThemeDef("toxic",        "Toxic Glow",    "#011000","#051a00","#030d00","#082500","#a3e635","#65a30d","#d9f99d", "COINS",  0, 85),
    ...
    public static final List<FontDef> ALL_FONTS = List.of(
        ...
        new FontDef("bahnschrift","Bahnschrift",          "Bahnschrift",         "LEVEL",  6, 0),
        new FontDef("trebuchet",   "Trebuchet MS",        "Trebuchet MS",        "LEVEL",  7, 0),
        new FontDef("candara",     "Candara",             "Candara",             "LEVEL",  9, 0),
        ...
        new FontDef("constantia",  "Constantia",          "Constantia",          "COINS",  0, 48),
        ...
        new FontDef("corbel",      "Corbel",              "Corbel",              "COINS",  0, 58),
        ...
        new FontDef("sitka",       "Sitka Small",         "Sitka Small",         "COINS",  0, 83),
